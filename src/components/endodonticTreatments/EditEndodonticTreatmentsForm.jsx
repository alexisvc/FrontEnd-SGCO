...
const EditEndodonticTreatmentsForm = ({
  ...
  const [formData, setFormData] = useState({
    dienteEnd: endodonticTreatmentsData?.dienteEnd || "",
    grapaEnd: endodonticTreatmentsData?.grapaEnd || "",
    diagDental: endodonticTreatmentsData?.diagDental || "",
    diagPulpar: endodonticTreatmentsData?.diagPulpar || "",
    intervencionIndicada: endodonticTreatmentsData?.intervencionIndicada || "",
    tecnicaObturacion: endodonticTreatmentsData?.tecnicaObturacion || "",
    numConductos: endodonticTreatmentsData?.numConductos || "",
    obsAnatomicas: endodonticTreatmentsData?.obsAnatomicas || "",
    etiologia: endodonticTreatmentsData?.etiologia || false,
    dolor: endodonticTreatmentsData?.dolor || false,
    pruebasClinicas: endodonticTreatmentsData?.pruebasClinicas || false,
    pruebasVitalidad: endodonticTreatmentsData?.pruebasVitalidad || false,
    camaraPulpar: endodonticTreatmentsData?.camaraPulpar || false,
    conductosRadiculares: endodonticTreatmentsData?.conductosRadiculares || false,
    foramen: endodonticTreatmentsData?.foramen || false,
    ligamentoPeriodontal: endodonticTreatmentsData?.ligamentoPeriodontal || false,
    otrosHallazgos: endodonticTreatmentsData?.otrosHallazgos || "",
    conductometriaTentativa: endodonticTreatmentsData?.conductometriaTentativa || "",
    conductometriaDefinitiva: endodonticTreatmentsData?.conductometriaDefinitiva || "",
    tecnicaInstrumentacion: endodonticTreatmentsData?.tecnicaInstrumentacion || "",
    medicacionIntra: endodonticTreatmentsData?.medicacionIntra || "",
  ...
  return (
    <Container>
        <Typography  variant="h5" align="center" gutterBottom>Editar Historia de Endodoncia</Typography>
        <Grid container spacing={2} sx={{margin: 2}}>
          ...
          <Typography variant="h6" align="center" gutterBottom>Examen Clínico</Typography>
          </Grid>
                ...
                <FormControlLabel
                    control={
                        <Checkbox
                            ...
                            checked={formData.pruebasClinicas.includes('recesionGingival')}
                            onChange={(e) => handleCheckboxChange(e, 'pruebasClinicas')}
                        />
                    }
                    ...
                    <FormControlLabel
                        control={
                            <Checkbox
                                ...
                                onChange={(e) => handleCheckboxChange(e, 'pruebasVitalidad')}
                            />
                        }
                        label="Frío"
                    />
          ...
          <Grid item xs={12}>
          <Typography variant="h6" align="center" gutterBottom>Examen Radiológico</Typography>
          </Grid>
              ...
              <FormGroup row>
                <FormControlLabel
                    control={
                        <Checkbox
                            ...
                            onChange={(e) => handleCheckboxChange(e, 'conductosRadiculares')}
                        />
                    }
                    label="Curvos"
                />
                ...
                <FormControlLabel
                    control={
                        <Checkbox
                            name="calcificados"
                            checked={formData.conductosRadiculares.includes('calcificados')}
                            onChange={(e) => handleCheckboxChange(e, 'conductosRadiculares')}
                        />
                    }
                    label="Calcificados"
                ...
                <FormControlLabel
                    control={
                        <Checkbox
                            name="bifurcado"
                            checked={formData.conductosRadiculares.includes('bifurcado')}
                            onChange={(e) => handleCheckboxChange(e, 'conductosRadiculares')}
                        />
                    }
                    label="Bifurcado"
                ...
                <FormControlLabel
                    control={
                        <Checkbox
                            name="obturados"
                            checked={formData.conductosRadiculares.includes('obturados')}
                            onChange={(e) => handleCheckboxChange(e, 'conductosRadiculares')}
                        />
                    }
                    label="Obturados"
                ...
                <FormControlLabel
                    control={
                        <Checkbox
                            name="estrechos"
                            checked={formData.conductosRadiculares.includes('estrechos')}
                            onChange={(e) => handleCheckboxChange(e, 'conductosRadiculares')}
                        />
                    }
                    label="Estrechos"
              ...
              <FormGroup row>
                <FormControlLabel
                    control={
                        <Checkbox
                            name="ensanchado"
                            checked={formData.ligamentoPeriodontal.includes('ensanchado')}
                            onChange={(e) => handleCheckboxChange(e, 'ligamentoPeriodontal')}
                        />
                    }
                    label="Ensanchado"
                />
                <FormControlLabel
                    control={
                        <Checkbox
                            name="discontinuo"
                            checked={formData.ligamentoPeriodontal.includes('discontinuo')}
                            onChange={(e) => handleCheckboxChange(e, 'ligamentoPeriodontal')}
                        />
                    }
                    label="Discontinuo"
          ...
          <Grid item xs={12} sx={{margin: 2}}> 
            <Typography variant="h6" align="center" gutterBottom>Preparación Mecánica del Conducto</Typography>
        </Grid>
