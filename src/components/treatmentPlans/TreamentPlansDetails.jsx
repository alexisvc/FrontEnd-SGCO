...
const TreamentPlansDetails = ({
  ...
  return (
    ...
    <Table>
      <TableHead>
        <TableRow>
          <TableCell align='center'><Typography variant='h7'>Cita</Typography></TableCell>
          <TableCell align='center'><Typography variant='h7'>Actividad Plan Tratamiento</Typography></TableCell>
          <TableCell align='center'><Typography variant='h7'>Fecha Plan Tratamiento</Typography></TableCell>
          <TableCell align='center'><Typography variant='h7'>Monto Abono</Typography></TableCell>
